...
访问 `http://localhost:5001/login.html`，用**公众号管理员微信**扫码登录。
...
如需通过域名或 HTTPS 访问，配置 Nginx 反向代理到 `localhost:5001`：
...
```bash
curl "http://localhost:5001/api/public/accountinfo?fakeid=YOUR_FAKEID"
```
